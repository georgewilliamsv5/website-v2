...
const socialLinks = [
  {
    href: "https://github.com/georgewilliamsv5",
    icon: (
      <svg
        width="24"
        height="24"
      ...
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          ...
          <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
            Reach out today to discuss your team or project needs and let&apos;s
            have a discussion!
          </p>
        ...
        <form
          action="https://getform.io/f/bjjoqwjb"
          method="POST"
